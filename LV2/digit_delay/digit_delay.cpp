...
#ifndef  __digit_delay_H__
#define  __digit_delay_H__
...
static float digit_delay_faustpower2_f(float value) {
	return (value * value);
	
}

#ifndef FAUSTCLASS 
#define FAUSTCLASS digit_delay
#endif
#ifdef __APPLE__ 
...
class digit_delay : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("filename", "digit_delay.dsp");
		m->declare("maths.lib/author", "GRAME");
		m->declare("maths.lib/copyright", "GRAME");
		m->declare("maths.lib/license", "LGPL with exception");
		m->declare("maths.lib/name", "Faust Math Library");
		m->declare("maths.lib/version", "2.1");
		m->declare("name", "digit_delay");
	...
	virtual digit_delay* clone() {
		return new digit_delay();
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("digit_delay");
		ui_interface->declare(0, "0", "");
		ui_interface->openVerticalBox("Knobs");
		ui_interface->declare(&fVslider6, "0", "");
		ui_interface->declare(&fVslider6, "midi", "ctrl 63");
		ui_interface->declare(&fVslider6, "style", "knob");
		ui_interface->addVerticalSlider("BPM", &fVslider6, 120.0f, 30.0f, 300.0f, 0.100000001f);
		ui_interface->declare(&fVslider5, "0", "");
		ui_interface->declare(&fVslider5, "midi", "ctrl 61");
		ui_interface->declare(&fVslider5, "style", "knob");
		ui_interface->addVerticalSlider("Delay", &fVslider5, 0.5f, 0.00100000005f, 16.0f, 0.00100000005f);
		ui_interface->declare(&fVslider7, "0", "");
		ui_interface->declare(&fVslider7, "midi", "ctrl 62");
		ui_interface->declare(&fVslider7, "style", "knob");
		ui_interface->addVerticalSlider("Warp", &fVslider7, 0.0f, -1.0f, 1.0f, 0.00100000005f);
		...
		ui_interface->declare(&fVslider0, "midi", "ctrl 75");
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow6 = (((0.144717798f * fSlow5) > 0.0f) ? std::exp((0.0f - (fConst3 / fSlow5))) : 0.0f);
		float fSlow7 = (fConst4 * (float(fVslider5) / float(fVslider6)));
		float fSlow8 = (1.0f - fSlow6);
		float fSlow9 = (fSlow7 * fSlow8);
		float fSlow10 = (float(fVslider7) * fSlow8);
		for (int i = 0; (i < count); i = (i + 1)) {
			fRec0[0] = (fSlow0 + (fConst1 * fRec0[1]));
			fRec3[(IOTA & 2097151)] = ((fSlow2 * fRec3[((IOTA - 1) & 2097151)]) + (fSlow1 * ((iSlow3 ? 0.0f : float(input0[i])) + (fSlow4 * fRec1[1]))));
			fRec4[0] = ((fRec4[1] * fSlow6) + fSlow9);
			int iTemp0 = int(fRec4[0]);
			float fTemp1 = std::floor(fRec4[0]);
			fRec1[0] = ((fRec3[((IOTA - std::min<int>(1048577, std::max<int>(0, iTemp0))) & 2097151)] * (fTemp1 + (1.0f - fRec4[0]))) + ((fRec4[0] - fTemp1) * fRec3[((IOTA - std::min<int>(1048577, std::max<int>(0, (iTemp0 + 1)))) & 2097151)]));
			fRec6[0] = ((fSlow6 * fRec6[1]) + fSlow10);
			fRec7[0] = (fSlow6 * fRec7[1]);
			fRec5[0] = ((fSlow6 * fRec5[1]) + (fSlow7 * (fSlow8 * ((fRec6[0] + digit_delay_faustpower2_f(fRec7[0])) + 1.0f))));
			int iTemp2 = int(fRec5[0]);
			float fTemp3 = std::floor(fRec5[0]);
			float fRec2 = ((fRec3[((IOTA - std::min<int>(1048577, std::max<int>(0, iTemp2))) & 2097151)] * (fTemp3 + (1.0f - fRec5[0]))) + ((fRec5[0] - fTemp3) * fRec3[((IOTA - std::min<int>(1048577, std::max<int>(0, (iTemp2 + 1)))) & 2097151)]));
			output0[i] = FAUSTFLOAT((fRec0[0] * fRec2));
			fRec0[1] = fRec0[0];
			IOTA = (IOTA + 1);
			fRec4[1] = fRec4[0];
			fRec1[1] = fRec1[0];
...
#ifndef PLUGIN_URI
#define PLUGIN_URI URI_PREFIX "/digit_delay"
#endif
...
struct LV2Plugin {
  ...
  static void init_meta()
  {
    if (!meta && (meta = new Meta)) {
      ...
      digit_delay* tmp_dsp = new digit_delay();
      if (tmp_dsp) {
  ...
  {
    return meta_get("name", "digit_delay");
  }
      ...
      vd(num_voices>0?new VoiceData(num_voices):0)
  {
    ...
    dsp = (digit_delay**)calloc(ndsps, sizeof(digit_delay*));
...
#endif
  if (!plugin_name || !*plugin_name) plugin_name = "digit_delay";
